...
import notice.controller.customer.NoticeDatailController;
...
//		NoticeDatailController controller1=new NoticeDatailController();
...
//				controller1.execute(request,response);
				ncontroller=new NoticeDatailController();
